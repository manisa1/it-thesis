...
def create_8_metrics_comprehensive_chart():
    ...
    # Create comprehensive 2x4 subplot layout with better spacing
    ...
    ax1.set_title('1. Offset on Metrics (ΔM)\n(Lower = Better)', fontweight='bold', fontsize=14, pad=20)
    ax1.set_ylabel('ΔM Value', fontsize=11)
    ...
    ax2.set_title('2. Performance Drop %\n(Lower = Better, Negative = Improvement)', fontweight='bold', fontsize=14, pad=20)
    ax2.set_ylabel('Drop %', fontsize=11)
    ...
    ax4.set_ylabel('RI Value', fontsize=11)
    ...
    ax5.set_ylabel('PS Value', fontsize=11)
    ...
    ax6.set_title('6. Jaccard Similarity\n(List Overlap - Higher = Better)', fontweight='bold', fontsize=14, pad=20)
    ax6.set_ylabel('Jaccard Score', fontsize=11)
    ...
    ax7.set_ylabel('TO Score', fontsize=11)
    ...
    ax8.set_title('8. RBO Similarity\n(Rank-Biased Overlap - Higher = Better)', fontweight='bold', fontsize=14, pad=20)
    ax8.set_ylabel('RBO Score', fontsize=11)
    ...
    plt.tight_layout()
    plt.subplots_adjust(bottom=0.15, top=0.88, hspace=0.6, wspace=0.4)
