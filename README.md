...
| NGCF | 0.2628 | 0.2179 | -1.2% | Improves Under Noise |
| **LightGCN** | 0.2604 | 0.2117 | **0.0%** | Perfect Robustness |
| **SimGCL** | 0.2604 | 0.2126 | **0.0%** | Perfect Robustness |
| SGL | 0.2329 | 0.2522 | -8.9% | Major Improvement |
| DCCF | 0.2024 | 0.0690 | 14.3% | Most Vulnerable |
...
|-------|----------|---------|--------|
| **LightGCN** | **0.000** | 1st | Perfect |
| **SimGCL** | **0.000** | 1st | Perfect |
| **Exposure-aware DRO** | **0.005** | 3rd | Excellent |
| NGCF | 0.012 | 4th | Good |
| PDIF | 0.041 | 5th | Moderate |
| SGL | 0.089 | 6th | Fair |
| DCCF | 0.143 | 7th | Vulnerable |
...
|-------|--------|---------|--------|
| **SGL** | **-8.9%** | 1st | Major Improvement |
| **NGCF** | **-1.2%** | 2nd | Improves Under Noise |
| **LightGCN** | **0.0%** | 3rd | Perfect Robustness |
| **SimGCL** | **0.0%** | 3rd | Perfect Robustness |
| **Exposure-aware DRO** | **0.5%** | 5th | Champion |
| PDIF | 4.1% | 6th | Moderate Drop |
| DCCF | 14.3% | 7th | Most Vulnerable |
...
| **LightGCN** | 0.000 | 6th | No Defense Needed |
| **SimGCL** | 0.000 | 6th | No Defense Needed |
...
|-------|----------|---------|--------|
| **LightGCN** | **0.000** | 1st | Perfect Stability |
| **SimGCL** | **0.000** | 1st | Perfect Stability |
...
|-------|---------------|---------|--------|
| **LightGCN** | **1.00** | 1st | Perfect Consistency |
| **SimGCL** | **1.00** | 1st | Perfect Consistency |
...
| DCCF | 0.72 | 7th | Lowest Consistency |
...
|-------|----------|---------|--------|
| **LightGCN** | **1.00** | 1st | Perfect Top-Item Stability |
| **SimGCL** | **1.00** | 1st | Perfect Top-Item Stability |
...
| DCCF | 0.70 | 7th | Least Stable Top Items |
...
|-------|-----------|---------|--------|
| **LightGCN** | **1.00** | 1st | Perfect Rank Preservation |
| **SimGCL** | **1.00** | 1st | Perfect Rank Preservation |
...
| DCCF | 0.68 | 7th | Poorest Rank Preservation |
